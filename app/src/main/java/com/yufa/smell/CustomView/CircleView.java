package com.yufa.smell.CustomView;
...
public class CircleView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBorderWidth != 0) {
            ...
            canvas.drawCircle(getWidth() / 2, getHeight() / 2, mBorderRadius-30, mBorderPaint);
    ...
    private void setup() {
        ...
        mDrawableRadius = Math.min(mDrawableRect.height() / 2-30, mDrawableRect.width() / 2);
